...
| MM-013 | High | Reopening a validated source parent by pathname left intermediate symlink and regular-directory replacement windows. | Reads and writes now open every directory component with no-follow, fd-relative traversal, keep the parent descriptor through replacement, and bind plans to parent device/inode identity. Adversarial symlink and hardlink-backed regular-directory swap tests prove neither target is changed. |
